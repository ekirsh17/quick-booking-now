...
**Quick Setup**: See [docs/RAILWAY_DEPLOYMENT.md](RAILWAY_DEPLOYMENT.md) for complete setup guide with all environment variable values.

1. Create a new Railway project
2. Connect your GitHub repository
3. Set root directory to `server/`
4. Add environment variables in Railway dashboard (see [RAILWAY_DEPLOYMENT.md](RAILWAY_DEPLOYMENT.md) for exact values)
5. Railway will auto-detect Node.js and deploy
6. Update `TWILIO_WEBHOOK_URL` after deployment with your Railway domain
...
2. Add all required secrets (see [docs/EDGE_FUNCTIONS_ENV_VARS.md](EDGE_FUNCTIONS_ENV_VARS.md))
3. Secrets are automatically available to all edge functions
4. No need to redeploy functions after adding secrets

### Required Secrets

See [docs/EDGE_FUNCTIONS_ENV_VARS.md](EDGE_FUNCTIONS_ENV_VARS.md) for complete list. Key secrets include:
...
### Production
- **Frontend URL**: `https://www.openalert.org`
