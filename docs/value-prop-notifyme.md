...
Merchants can manage openings entirely via SMS — no need to open an app:

| Text Message | What Happens |
|--------------|--------------|
| `"add 2pm"` | Creates a 2pm opening |
| `"my 2pm cancelled"` | AI understands and marks the 2pm slot as available |
...
3. **Notifies customers** — Texts waitlisted clients about availability
4. **Lets them claim** — Customers tap a link to book instantly

### Why This Matters

- **No app switching** — Manage openings from your pocket
- **No learning curve** — Text naturally, AI figures it out
- **No extra software** — Works with your existing booking system
- **Instant results** — Openings filled while you're still with clients
...
### Reporting Page
- **Header subtitle:** "Slots you might have lost, now filled."
- **Revenue card note:** "Based on your average appointment value"
- **Empty state:** "No openings filled yet. Create your first opening to get started."

### Onboarding
- **Headline:** "Fill last-minute cancellations automatically"
- **Subhead:** "Text us your openings. We'll text your customers."
...
- Books appointments (salons, barbershops, spas, clinics, studios)
- Experiences regular cancellations or no-shows
- Wants to fill gaps without manual outreach
- Prefers simple tools over complex software
- Already has a booking system (or uses pen & paper)
