...
export const WeekView = ({
  ...
  const { minHour, maxHour } = useMemo(() => {
    ...
    // Store original working hours before extending
    ...
    <div className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
      ...
      >
        ...
        <div className="sticky top-0 z-30 bg-card/95 backdrop-blur-sm">
          ...
          <div className="hidden md:flex items-center justify-between px-4 py-1.5 border-b border-border/30">
            <Button
              variant="ghost"
              size="sm"
          ...
          <div className="md:hidden flex items-center justify-between px-4 py-1.5 border-b border-border/30">
            <Button
              variant="ghost"
              size="sm"
