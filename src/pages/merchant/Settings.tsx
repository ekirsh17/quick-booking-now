    ...
    <MerchantLayout>
      <div className="max-w-2xl mx-auto space-y-8 pb-32 relative">
        ...
        <Button 
          onClick={handleSave} 
          size="lg" 
          className="fixed md:absolute bottom-20 right-4 md:bottom-4 md:right-4 z-50 shadow-2xl md:shadow-none h-12 px-6 transition-all flex items-center justify-center" 
          disabled={loading}
        >
