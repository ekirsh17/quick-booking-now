    ...
    <MerchantLayout>
      <div className="max-w-2xl mx-auto space-y-8 pb-2 relative">
        ...
        <Button 
          onClick={handleSave} 
          size="lg" 
          className="fixed bottom-20 sm:bottom-16 md:bottom-8 lg:bottom-6 right-4 sm:right-6 z-50 shadow-2xl h-12 px-6 transition-all flex items-center justify-center" 
          disabled={loading}
        >
