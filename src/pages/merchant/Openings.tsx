  ...
  return (
    <MerchantLayout>
      ...
      <Button
        ...
        size="lg"
        className="fixed bottom-20 right-4 md:bottom-6 md:right-4 lg:right-8 xl:right-16 z-50 shadow-2xl h-12 lg:h-14 px-4 lg:px-6 flex items-center justify-center"
      >
