    ...
    <MerchantLayout>
      <div className="space-y-6 relative pb-0">
        ...
        <Button
          ...
          size="lg"
          className="fixed bottom-24 sm:bottom-20 md:bottom-12 lg:bottom-12 xl:bottom-10 2xl:bottom-8 right-4 sm:right-6 z-50 shadow-2xl h-12 lg:h-14 px-4 lg:px-6 flex items-center justify-center"
        >
